...
class MageGoat_GetMember_Block_Member_Points extends Mage_Checkout_Block_Cart_Abstract
{
    /**
     * Product Collection
     *
     * @var MageGoat_GetMember_Model_Resource_Point_Collection
     */
    ...
    protected function _getPointCollection()
    {
        if (is_null($this->_pointCollection)) {
            ...
            /** @var $memberModel MageGoat_GetMember_Model_Member */

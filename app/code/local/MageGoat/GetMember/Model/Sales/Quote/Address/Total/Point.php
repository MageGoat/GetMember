...
class MageGoat_GetMember_Model_Sales_Quote_Address_Total_Point extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if($this->_getCheckout()->getApplyMemberPoint()) { //your business logic
            ...
            /** @var $_memberModel MageGoat_GetMember_Model_Member */
